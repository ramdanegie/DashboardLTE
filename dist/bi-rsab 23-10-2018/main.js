...
var DashboardPendapatanComponent = /** @class */ (function () {
    ...
    DashboardPendapatanComponent.prototype.getPendapatanRS = function () {
        ...
        this.httpservice.getTransaksi('eis-pendapatan/get-pendapatan-rs?tglAwal=' + tgl + '&tglAkhir=' + tgl).subscribe(function (data) {
    ...
    DashboardPendapatanComponent.prototype.getTargetRealisasi = function () {
        this.chartTargetRealisi = new angular_highcharts__WEBPACK_IMPORTED_MODULE_3__["Chart"]({
            chart: {
                zoomType: 'xy'
            },
            title: {
            ...
            yAxis: [{
                    ...
                    title: {
                        text: '',
                        style: {
                            color: angular_highcharts__WEBPACK_IMPORTED_MODULE_3__["Highcharts"].getOptions().colors[0]
                        }
                    },
                    labels: {
                        format: '{value}',
            ...
            legend: {
                ...
                y: 100,
                floating: true,
                backgroundColor: (angular_highcharts__WEBPACK_IMPORTED_MODULE_3__["Highcharts"].theme && angular_highcharts__WEBPACK_IMPORTED_MODULE_3__["Highcharts"].theme.legendBackgroundColor) || '#FFFFFF'
            },
            series: [{
                    name: 'Target',
                    type: 'column',
...
module.exports = "<section class=\"content-header\">\r\n    <h1>\r\n      Persediaan\r\n      <small>{{now |date}}</small>\r\n    </h1>\r\n    <ol class=\"breadcrumb\">\r\n      <li><a routerLink=\"/dashboad-pendapatan\"><i class=\"fa fa-home\"></i>Dashboard Persediaan</a></li>\r\n      <!-- <li class=\"active\">Dashboard</li> -->\r\n    </ol>\r\n  </section>\r\n  \r\n  <section class=\"content\">\r\n    <div class=\"ui-g-12\">\r\n      <mk-box header=\"Rekap Penerimaan Barang Harian\" styleClass=\"box\" boxColor=\"#8a2be2\" headerStyleClass=\"box-header\">\r\n  \r\n      </mk-box>\r\n    </div>\r\n    <div class=\"ui-g-6\">\r\n      <mk-box header=\"Stok Rumah Sakit\" styleClass=\"box\" boxColor=\"#ff288d\" headerStyleClass=\"box-header\">\r\n  \r\n      </mk-box>\r\n    </div>\r\n    <div class=\"ui-g-6\">\r\n      <mk-box header=\"Pengeluaran Harian\" styleClass=\"box\" boxColor=\"#ffc300\" headerStyleClass=\"box-header\">\r\n      </mk-box>\r\n    </div>\r\n  \r\n  </section>"
...
var DashboardPersediaanComponent = /** @class */ (function () {
    function DashboardPersediaanComponent() {
        this.now = new Date();
    }
    DashboardPersediaanComponent.prototype.ngOnInit = function () {
    };
    DashboardPersediaanComponent.prototype.getChartRealisasiPendapatan = function () {
    };
...
var DashboardSdmComponent = /** @class */ (function () {
    function DashboardSdmComponent(httpservice) {
        this.httpservice = httpservice;
        this.now = new Date();
    ...
    DashboardSdmComponent.prototype.getData = function () {
        ...
        this.httpservice.getTransaksi('eis-sdm/get-count-pegawai').subscribe(function (data) {
           ...
           */
            ...
            _this.totalAktif = totalAktifs;
            _this.totalNonAktif = totalNonAktifs; //this.totalPaegawai - totalAktifs - totalPensiuns
            _this.totalPensiun = totalPensiuns;
            _this.totalPaegawai = totalAktifs + totalNonAktifs + totalPensiuns;
            // total Pegawai kabeh
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.appservice.getTransaksi('eis/get-trend-kunjungan-rawatjalan').subscribe(function (data) {
            _this.isShowTrend = false;
            _this.trendKunjungan = data;
            for (var i in _this.trendKunjungan) {
                _this.data1.push({
                    y: parseFloat(_this.trendKunjungan[i].totalterdaftar),
                    color: _this.colorNyieun[i]
                });
            }
            for (var i in _this.trendKunjungan) {
                _this.data2.push({
                    y: parseFloat(_this.trendKunjungan[i].diperiksa),
                    color: _this.colorNyieun[i]
                });
            }
            for (var i in _this.trendKunjungan) {
                _this.data3.push({
                    y: parseFloat(_this.trendKunjungan[i].belumperiksa),
                    color: _this.colorNyieun[i]
                });
            }
            for (var i in _this.trendKunjungan) {
                _this.data4.push({
                    y: parseFloat(_this.trendKunjungan[i].batalregistrasi),
                    color: _this.colorNyieun[i]
                });
            }
            for (var i in _this.trendKunjungan) {
                _this.categories.push(_this.trendKunjungan[i].tanggal);
            }
...
module.exports = __webpack_require__(/*! D:\Egie Ramdan\ProjectHK\Dashboard\DashboardLTE\src\main.ts */"./src/main.ts");
